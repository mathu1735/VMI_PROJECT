...
import com.vmi.entity.RolesDataOnDemand;
...
privileged aspect RolesDataOnDemand_Roo_DataOnDemand {
    ...
    public void RolesDataOnDemand.setNameDa(Roles obj, int index) {
        String nameDa = "nameDa_" + index;
        if (nameDa.length() > 50) {
            nameDa = nameDa.substring(0, 50);
        }
        obj.setNameDa(nameDa);
    }
